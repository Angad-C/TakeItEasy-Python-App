...
You will have 3 chances, if you don't say it correctly on the 3rd time, the word will be skipped and it will move on to the next word!
Have fun!
""")
...
story = f_buffer.read()
per_word = story.split()
len_file = len(per_word)
...
for p in paras:
    ...
    print("")
percentage_missed = round(((missed_words_count/len_file)*100),2)
print("")
print("=======================================================")
print("Here is your feedback!")
print("=======================================================")
print("")
print("You missed "+str(missed_words_count)+" words, which means that you missed "+str(percentage_missed)+"% of the total amount of words in the file.")
time.sleep(3)
exit()